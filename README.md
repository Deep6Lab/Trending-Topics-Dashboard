# A Web-Based Interactive Dashboard to Detect Trends in Financial Journals
...
### Environment Setup for Windows
 ...
 1. Create a virtual environment for the project following these steps:
    ...
    - <img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/anaconda_env.PNG" width="700px" height="500px" />
...
#### Install Required Libraries
 ...
 1. Install the required libraries following these steps:
    ...
    - <img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/install_command.PNG" width="700px" height="45px" />
...
#### Start & Run the App
 ...
 1. Open and run __[05_dashboard.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/05_dashboard.ipynb)__ notebook. Then click on the URL output from the last cell to launch the app. **Note:** Sometimes the port number might already be running on your system. In that case change the port numerb to 5000 or 7000.
    - <img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/dash_app.PNG" width="600px" height="170px" />
...
### Environment Setup for Mac
 ...
 1. Click on the __Home__ tab on the left panel of __Anaconda__ and do the followings:
    ...
    - <img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/Terminal_Screenshot.png" width="600px" height="170px" />
...
#### Install Required Libraries
 1. In the same terminal, 
    - Clone this repository using the command __git clone https://github.com/Nayanapm1/uidashboard.git__
...
#### Start & Run the App
 ...
 3. Open and run __[05_dashboard.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/05_dashboard.ipynb)__ notebook. Then click on the URL output from the last cell to launch the app. **Note:** Sometimes the port number might already be running on your system. In that case change the port numerb to 5000 or 7000.
    - <img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/dash_app.PNG" width="600px" height="170px" />
...
<img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/dashboard_front_page.PNG" width="1000px" height="600px" />

#### Journal Trends: Advanced UI

<img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/advanced_ui.PNG" width="1000px" height="600px" />

#### Journal Trends: Diagnostics

<img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/diagnostics.PNG" width="1000px" height="400px" />

#### Dataset

<img src="https://github.com/Nayanapm1/uidashboard/blob/master/images/dataset.PNG" width="1000px" height="600px" />
...
1. Data preprocessing: [00_data_preprocessing.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/00_data_preprocessing.ipynb)
1. Feature extraction: [01_features_extraction.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/01_features_extraction.ipynb)
1. Data Normalization/Reduction: [02_feature_engineering.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/02_feature_engineering.ipynb)
1. Biased clustering model
   - [Biased_Clusters.py](https://github.com/Nayanapm1/uidashboard/blob/master/Biased_Clusters.py)
   - [Example](https://github.com/Nayanapm1/uidashboard/blob/master/03_biased_clustering.ipynb)
1. Model Results: [04_model_results.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/04_model_results.ipynb)
1. Interactive Dashboard: [05_dashboard.ipynb](https://github.com/Nayanapm1/uidashboard/blob/master/05_dashboard.ipynb)
